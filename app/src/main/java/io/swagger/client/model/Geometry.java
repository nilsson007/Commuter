...
public class Geometry {
  ...
  public boolean equals(Object o) {
    ...
    return (this.errorText == null ? geometry.errorText == null : this.errorText.equals(geometry.errorText)) &&
        (this.error == null ? geometry.error == null : this.error.equals(geometry.error)) &&
        (this.serverdate == null ? geometry.serverdate == null : this.serverdate.equals(geometry.serverdate)) &&
        (this.servertime == null ? geometry.servertime == null : this.servertime.equals(geometry.servertime)) &&
        (this.points == null ? geometry.points == null : this.points.equals(geometry.points)) &&
        (this.noNamespaceSchemaLocation == null ? geometry.noNamespaceSchemaLocation == null : this.noNamespaceSchemaLocation.equals(geometry.noNamespaceSchemaLocation));
  }
