...
import io.swagger.client.model.ArrivalBoard;
...
public class ArrivalBoardApi {
  ...
  * This method will return the next 20 arrivals (or less if not existing) from a given point in time or the next arrivals in a given timespan. The service can only be called for stops/stations by using according ID retrieved by the location method. The parameter is called id. The time and date are defined with the parameters date and time.
   ...
   * @return ArrivalBoard
  */
  public ArrivalBoard getArrivalBoard (Long id, Date date, String time, Long direction, String useVas, String useLDTrain, String useRegTrain, String useBus, String useBoat, String useTram, String excludeDR, Integer timeSpan, Integer maxDeparturesPerLine, String needJourneyDetail, String format, String jsonpCallback) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'id' is set
    if (id == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'id' when calling getArrivalBoard",
        new ApiException(400, "Missing the required parameter 'id' when calling getArrivalBoard"));
    }
    // verify the required parameter 'date' is set
    if (date == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'date' when calling getArrivalBoard",
        new ApiException(400, "Missing the required parameter 'date' when calling getArrivalBoard"));
    }
    // verify the required parameter 'time' is set
    if (time == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'time' when calling getArrivalBoard",
        new ApiException(400, "Missing the required parameter 'time' when calling getArrivalBoard"));
    }
    // verify the required parameter 'direction' is set
    if (direction == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'direction' when calling getArrivalBoard",
        new ApiException(400, "Missing the required parameter 'direction' when calling getArrivalBoard"));
    }

    // create path and map variables
    String path = "/arrivalBoard";
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (ArrivalBoard) ApiInvoker.deserialize(localVarResponse, "", ArrivalBoard.class);
      } else {
         return null;
      }
  ...
  */
  public void getArrivalBoard (Long id, Date date, String time, Long direction, String useVas, String useLDTrain, String useRegTrain, String useBus, String useBoat, String useTram, String excludeDR, Integer timeSpan, Integer maxDeparturesPerLine, String needJourneyDetail, String format, String jsonpCallback, final Response.Listener<ArrivalBoard> responseListener, final Response.ErrorListener errorListener) {
    ...
    // create path and map variables
    String path = "/arrivalBoard".replaceAll("\\{format\\}","json");
      ...
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((ArrivalBoard) ApiInvoker.deserialize(localVarResponse,  "", ArrivalBoard.class));
