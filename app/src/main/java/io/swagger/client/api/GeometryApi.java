...
public class GeometryApi {
  ...
  * Returns the polyline for a leg. This service can not be called directly but only by reference URLs in a result of a trip or JourneyDetail request. The result contains a list of WGS84 coordinates which can be used to display the polyline on a map.If the parameter needItinerary&#x3D;1 is passed in the URL of the trip request that contained the reference to the Geometry service, the geometry reference link will also contain an itinerary for walk, bike and car legs, that can be used to generate turn-by-turn instructions.
   ...
   * @return Geometry
  */
  public Geometry getGeometry (String ref) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'ref' is set
    if (ref == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'ref' when calling getGeometry",
        new ApiException(400, "Missing the required parameter 'ref' when calling getGeometry"));
    }
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (Geometry) ApiInvoker.deserialize(localVarResponse, "", Geometry.class);
      } else {
         return null;
      }
   ...
   * @param ref the ref query parameter, URL decoded, from a URL retrieved as a result of a trip or JourneyDetail request
  */
  public void getGeometry (String ref, final Response.Listener<Geometry> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/geometry".replaceAll("\\{format\\}","json");
      ...
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((Geometry) ApiInvoker.deserialize(localVarResponse,  "", Geometry.class));
